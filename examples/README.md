...
**base_1cc_zpa** - Everything from base_1cc + Creates a dedicated Azure DNS Private Resolver subnet, Resolver Ruleset/Rules, and Outbound Endpoint for conditional DNS forwarding
...
**base_cc_lb_zpa** - Everything from base_cc_lb + Creates a dedicated Azure DNS Private Resolver subnet, Resolver Ruleset/Rules, and Outbound Endpoint for conditional DNS forwarding
```
